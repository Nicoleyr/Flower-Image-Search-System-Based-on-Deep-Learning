...
class Network():
    ...
    def define_graph(self):
        ...
        with self.graph.as_default():
            ...
            rate = tf.train.exponential_decay(0.1, step, 50, 0.99)
            self.optimizer = tf.train.AdamOptimizer(rate).minimize(self.loss)
...
if __name__ == '__main__':
    net = Network(num_hidden=256, batch_size=128)
    net.define_graph()
    net.run()
